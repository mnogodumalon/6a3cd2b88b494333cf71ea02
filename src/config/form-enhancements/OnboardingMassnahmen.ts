// Auto-generated. Per-entity form-enhancements config for "Onboarding-Maßnahmen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["mitarbeitender", "bezeichnung", "typ", "datum_uhrzeit", {"row": ["verantwortliche_vorname", "verantwortliche_nachname"]}, "status_massnahme", "notizen_massnahme"],
  defaults: {
    'datum_uhrzeit': { kind: 'today', withTime: true },
    'status_massnahme': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
  },
  computed: {},
};
