// Auto-generated. Per-entity form-enhancements config for "Onboarding-Checkliste".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["mitarbeitender", "aufgabe_bezeichnung", "kategorie", "faelligkeitsdatum", {"row": ["verantwortliche_aufgabe_vorname", "verantwortliche_aufgabe_nachname"]}, "erledigt", "anmerkungen"],
  defaults: {
    'faelligkeitsdatum': { kind: 'todayOffset', days: 7 },
