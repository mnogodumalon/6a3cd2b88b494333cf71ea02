...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{"row": ["vorname", "nachname"]}, "email_geschaeftlich", "telefon", "eintrittsdatum", "abteilung", "position", {"row": ["vorgesetzte_vorname", "vorgesetzte_nachname"]}, "arbeitsort", "vertragsart"],
  defaults: {
    'eintrittsdatum': { kind: 'today' },
    'vertragsart': { kind: 'lookup', key: 'vollzeit', label: 'Vollzeit' },
  },
  computed: {},
};
