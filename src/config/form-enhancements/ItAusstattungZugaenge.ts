// Auto-generated. Per-entity form-enhancements config for "IT-Ausstattung & Zugänge".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'email_konto_erstellt': { kind: 'literal', value: false },
    'vpn_zugang_eingerichtet': { kind: 'literal', value: false },
    'zugangsdaten_uebergeben': { kind: 'literal', value: false },
  },
  computed: {},
};
